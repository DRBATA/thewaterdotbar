  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        cream: {
          50: "#FAF7F2", // Lighter cream for backgrounds
          100: "#F5F0E9",
        },
        beige: {
          100: "#EDEAE0", // Subtle beige for accents or gradients
        },
        amber: {
          // Using amber for a warm, golden, premium accent
          50: "#fffbeb",
          100: "#fef3c7",
          200: "#fde68a",
          300: "#fcd34d",
      ...
      fontFamily: {
        sans: ["Inter", "sans-serif"], // Example: Using Inter as a clean sans-serif
